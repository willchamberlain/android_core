...
public class LandmarkFeatureLoader {
    ...
    public HashMap<Integer, double[]> loadLandmarkFeatures() {
...
//        landmarks.put(1170, new double[]{-750, 0.0, 1260});
        ...
        landmarks.put( 970, new double[]{2240,   0,   0});
        landmarks.put(1210, new double[]{2740,   0,   0});
        landmarks.put(1250, new double[]{2740, 500,   0});
        landmarks.put(1170, new double[]{2240, 500,   0});
    /*  TODO - HARDCODING  */
        return landmarks;
    }
}