...
public class LocalisePnP_BoofCV implements PoseFrom3D2DPointMatches {
    ...
    public static void main(String[] args) {
        ...
        /** 2017_08_12 : /mnt/nixbig/ownCloud/project_AA1__1_1/results/2017_08_12/ ****************/
         /* x_px: 293.6748  294.2455  392.4144  414.1029
         y_px: 446.5404  419.1445  421.4275  449.3942
         fx=432.4505, fy=1009.4002
         px=243.6099719677942, py=319.0763942147772
         */
        double[] worldX_test  = {0,               0,               500,               500};
        double[] worldY_test  = {2240,         2740,              2740,              2240};
        double[] worldZ_test  = {0,               0,                 0,                 0};
        double[] pixelsX_test = {293.6748d,	294.2455d,	392.4144d,	414.1029d};
